...
function gtg_weights(sr::Int, gtg_params::GammatonegramParams)
...
function gammatonegram(x::Array{Float64,1}, wts::Array{Float64,2}, sr::Int, gtg_params::GammatonegramParams)
    ...
    gtg = max.(gtg, gtg_params.logconstant)
    gtg = 20.0*log.(10, gtg) # use 20 because using amplitude for gtg
    gtg = max.(gtg, gtg_params.dBthreshold)
